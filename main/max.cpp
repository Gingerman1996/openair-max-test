...
extern "C" void app_main(void) {
  ...
  gpio_set_direction(EN_PMS1, GPIO_MODE_OUTPUT);
  gpio_set_direction(EN_PMS2, GPIO_MODE_OUTPUT);
  ...
  int toSleepMs =
      (g_configuration.getConfigSchedule().pm02 * 1000) - aliveTimeSpendMillis;
  if (toSleepMs < 0) {
